...
class LoadingButton @JvmOverloads constructor(
    ...
    init {
        if (attrs != null) {
            ...
            if (ta.hasValue(R.styleable.LoadingButton_android_fontFamily)) {
                val fontId = ta.getResourceId(R.styleable.LoadingButton_android_fontFamily, -1)
                mTextPaint.typeface = ResourcesCompat.getFont(context, fontId)
            }
//            val fontFamilyId: Int =
//                ta.getResourceId(R.styleable.LoadingButton_android_fontFamily, 0)
//            if (fontFamilyId > 0) {
//                mTextPaint.typeface = ResourcesCompat.getFont(context, fontFamilyId)
//            }
            ta.recycle()
        }
...
private fun Paint.setShadowDepth(depth: Float){
    this.setShadowLayer(depth, 0f, 0f, 0x00000000)
}